...
PRINT
PRINT "This text-based program dumps accelerometer readings from a Texas Instruments SensorTag. A SensorTag is required to use this program. See SensorTag for a GUI based program that shows all six SensorTag sensors."
PRINT
